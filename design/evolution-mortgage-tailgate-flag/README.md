...
- **Black / gold** (for the West Point tailgate): lockup in Army West Point gold `#D4BF91` (Pantone 467 C) on a black field with a charcoal glow and a grey helix watermark.
...
- Colors (RGB masters, printer converts): navy `#0B1F3F`, glow centre `#163D72`, deep blue `#1456AA`, cyan `#21A0DE`, white. Black colorway: field `#0A0A0A` to `#3B3B3B`, gold `#D4BF91` (Pantone 467 C), helix at 26 % white.
